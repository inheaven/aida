...
public class OkCoinTradeServiceRaw extends OKCoinBaseTradePollingService {
    ...
    public OkCoinTradeResult trade(String symbol, String prompt, String type, String rate, String amount) throws IOException {
        OkCoinTradeResult tradeResult = okCoin.trade(apikey, symbol, prompt, type, rate, amount, signatureCreator, 0);
    ...
    public OkCoinTradeResult cancelOrder(long orderId, String symbol, String prompt) throws IOException {
        OkCoinTradeResult tradeResult = okCoin.cancelOrder(apikey, orderId, symbol, prompt, signatureCreator);
    ...
    public OkCoinOrderResult getOrder(long orderId, String symbol, String prompt) throws IOException {
        OkCoinOrderResult orderResult = okCoin.getOrder(apikey, orderId, symbol, prompt, "1", 0, 50, signatureCreator);
    ...
    public OkCoinOrderResult getOrder(long orderId, String symbol, String prompt, Integer page) throws IOException {
        OkCoinOrderResult orderResult = okCoin.getOrder(apikey, orderId, symbol, prompt, "1", page, 50, signatureCreator);
    ...
    public OkCoinCrossPositionResult getCrossPosition(String symbol, String prompt) throws IOException{
        return returnOrThrow(okCoin.getFuturesCrossPositions(apikey, symbol, prompt, signatureCreator));
    }
}
