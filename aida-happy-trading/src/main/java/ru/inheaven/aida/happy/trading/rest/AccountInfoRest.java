...
public class AccountInfoRest extends AbstractRestResource<JsonWebSerialDeserial>{
    private Date startDate = new Date(Timestamp.valueOf("2015-11-16 6:00:00").getTime());
    private Date startCnDate = new Date(Timestamp.valueOf("2015-11-16 6:00:00").getTime());
