...
public class AccountInfoRest extends AbstractRestResource<JsonWebSerialDeserial>{
    private Date startDate = new Date(Timestamp.valueOf("2016-04-04 6:00:00").getTime());
    private Date startCnDate = new Date(Timestamp.valueOf("2016-04-04 6:00:00").getTime());
