...
//    final static VectorForecastSSA vf1 = new VectorForecastSSA(512, 256, 8, 30);
    final static VectorForecastSSA vf2 = new VectorForecastSSA(1024, 256, 16, 30);
    final static VectorForecastSSA vf3 = new VectorForecastSSA(2048, 512, 64, 30);
    ...
    public EurUsdOraclePage() {
        ...
        data.add(new Series(dataSets, "EDU1", Color.BLACK, new LineGraphType(null, false, null)));
//        data.add(new Series(dataSets, "EDU1-" + vf1.getName(), Color.GREEN, new LineGraphType(null, false, null)));
        ...
        container.add(new AjaxSelfUpdatingTimerBehavior(Duration.seconds(5)) {
            ...
            protected void onPostProcessTarget(AjaxRequestTarget target) {
                ...
                List<Series> data = new ArrayList<Series>();
                List<Quote> allQuotes = quotesBean.getQuotes("EDU1", size);
...
//                data.add(new Series(dataSetsF1, "EDU1-" + vf1.getName(), Color.GREEN, new LineGraphType(null, false, null)));
                ...
                float[] f2 = vf2.execute(QuoteUtil.getAveragePrices(allQuotes.subList(size - vf2.getN(), size)));
                ...
                float[] f3 = vf3.execute(QuoteUtil.getAveragePrices(allQuotes.subList(size - vf3.getN(), size)));
                ...
                data.add(new Series(dataSetsF3, "EDU1-" + vf3.getName(), Color.BLUE, new LineGraphType(null, false, null)));



                target.appendJavaScript("plot.setData("+getData(data)+"); plot.draw();");
            }
        });
