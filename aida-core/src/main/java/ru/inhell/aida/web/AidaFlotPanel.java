 ...
 *         Date: 26.07.11 21:21
 */
public class AidaFlotPanel  extends Panel {
    ...
    public AidaFlotPanel(final String id, final IModel<List<Series>> model) {
		super(id, model);
	...
	private String getFlotScript() {
		try {
			final String str = getResourceContents(AidaFlotPanel.class, "FlotPanel.js");
...
//			LOGGER.info("{}", options);
	 ...
	 * @throws java.io.FileNotFoundException If the resource cannot be found.
